...
--
INSERT INTO
  tblproductpt (id, name, freshCutValue)
VALUES
  (1, "Red Roses 23cm", 10),
...
VALUES
  ...
  (5, "CandyFlowers");
INSERT INTO
  tblboxtypept (id, code, width, height, length)
VALUES
  (1, "1111", 12.1, 12.8, 11.2),
...
VALUES
  ...
  (5, 5, 3, 4, 12.3, 1, 1.2);
INSERT INTO
  tblcustomerpt (id, name, markdown)
VALUES
  (1, "Luis", "5"),
  (2, "Daniel", "2"),
  (3, "William", "3"),
...
--
  -- DROP TABLE tblcompanypt;
  -- DROP TABLE tblinventorypt;
  -- DROP TABLE tblproductpt;
  -- DROP TABLE tblboxtypept;
  -- DROP TABLE tblcustomerpt;
--
